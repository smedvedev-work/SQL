...
-- 0 - в начале запустить
-- 1 - в конце запустить
declare @mode int = 0 -- 0 - start, 1 finish


-- set aos name for user sessions filter
declare @aosName nvarchar(32) = 'LG-NS-APP-PROD' 

declare @AX_sessionNum nvarchar(1024) = '' 
...
*/
              ...
              insert tempdb..AX_sessions_locks select * from #AX_sessions_locks 
                ...
                select '@mode must be 0 or 1 only', @mode
/*
--for get result
